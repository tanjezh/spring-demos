...
public class PoetCreateRepository {
    ...
    public void test() {
        this.save(11, "tan");
        this.save2(12, "tantan");
        this.save3(13, "tanBlog");


        this.batchSave(Arrays.asList(new PoetBO(14, "t"), new PoetBO(15, "ta")));
        this.batchSave2(Arrays.asList(new PoetBO(16, "tan"), new PoetBO(17, "tantan")));
        this.batchSave3(Arrays.asList(new PoetBO(18, "Tan"), new PoetBO(19, "TanBlog")));
