...
public class Application implements CommandLineRunner {
	...
	public void run(final String... args) throws Exception {
		...
		influxDBTemplate.write("mytest", "1_h", p1);

		final Point p2 = Point.measurement("cpu")
				.time(System.currentTimeMillis(), TimeUnit.MILLISECONDS).tag("tenant", "dragon")
				...
				.build();
		influxDBTemplate.write("mytest", "2_h", p2);
